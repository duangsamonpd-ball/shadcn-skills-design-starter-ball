...
4. Run the accessibility lens with `../_ux-ui-shared/accessibility/wcag-checklist.md`; use `python3 ../_ux-ui-shared/scripts/contrast.py "<fg>" "<bg>"` for any color-pair doubts. (Deeper audit → the `a11y-audit` skill.)
