...
4. **Rebuild layout + components** token-driven via `../_ux-ui-shared/frameworks/adapter-protocol.md` + `../_ux-ui-shared/components/*`: one shared primitive layer, all 8 states, a11y wired, no emoji (lucide), single theme. Apply taste (`design-taste.md`) so it doesn't regress to generic.
